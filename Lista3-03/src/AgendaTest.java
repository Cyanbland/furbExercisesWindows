...
class AgendaTest {
	...
	public void testAdicionarMesmaData() {
		...
		assertTrue(agenda.addDataAgenda(da1));
		assertFalse(agenda.addDataAgenda(da2));
	}
	...
	public void testAdicionarDatasDiferentes() {
		...
		assertTrue(agenda.addDataAgenda(da1));
		assertTrue(agenda.addDataAgenda(da2));
		// n�o verifico se ficou guardado em Agenda pois n�o defini no modelo um m�todo
