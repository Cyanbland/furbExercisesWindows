...
public class Apresentacao extends javax.swing.JFrame {
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
		try {
			...
			if (jTextField4.getText().isEmpty() && jTextField5.getText().isEmpty()) {
				e = new Evento(jTextField1.getText(), Double.parseDouble(jTextField2.getText()),
						LocalDate.parse(jTextField3.getText(), formatter));
			} else {
				e = new ShowMusical(jTextField1.getText(), Double.parseDouble(jTextField2.getText()),
						LocalDate.parse(jTextField3.getText(), formatter), jTextField4.getText(),
						jTextField5.getText());
			}
			jComboBox1.addItem(e);
			JOptionPane.showMessageDialog(this, "Evento cadastrado:" + e.getTitulo());
	...
	private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton2ActionPerformed
		try {
			...
			e.setAval(a);
			JOptionPane.showMessageDialog(this, "Avaliacao cadastrada!");
		} catch (NumberFormatException nfe) {
